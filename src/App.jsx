...
export default function App() {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh' }}>
        ...
        <div className="topbar">
          ...
          <div className="topbar-actions">
            ...
            >
              ...
              {/* ← this span hides on mobile via CSS */}
              <span className="topbar-new-rental-text"> New Rental</span>
            </button>
          </div>
        </div>
      ...
      {/* Bottom nav — hidden on desktop, visible on mobile via CSS */}
        ...
        <div className="modal-overlay open">
          <div className="modal">
            ...
            <table style={{ fontSize: '13px', width: '100%' }}>
              <tbody>
                <tr>
                  <td style={{ color: 'var(--text-muted)', padding: '4px 0' }}>Booking ID</td>
                  <td style={{ textAlign: 'right', fontWeight: 600 }}>#1043</td>
                </tr>
                <tr>
                  <td style={{ color: 'var(--text-muted)', padding: '4px 0' }}>Vehicle</td>
                  <td style={{ textAlign: 'right' }}>City Bike</td>
                </tr>
                <tr>
                  <td style={{ color: 'var(--text-muted)', padding: '4px 0' }}>QR Unlock Code</td>
            ...
            <div className="modal-footer">
              ...
              <button
                ...
                onClick={() => { setBookingModal(false); setPage('activeride'); }}
              >
